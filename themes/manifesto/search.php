...
<div class="content-bg">
	...
	<div class="container">
		<h1 class="search-results-title"><i class="fa fa-search"></i> Vous avez recherché: &ldquo;<span><?php echo search_term(); ?></span>&rdquo;</h1>
	</div>
	...
	<?php else: ?>
	<div class="container">
		<p>Rien a été trouvé, tentez à nouveau ci dessous.</p>
