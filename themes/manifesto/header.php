			...
			<aside class="jpanel-menu menu-panel hidden">
				<div class="menu-panel__menu-wrap">
					...
					<form class="site-search" action="<?php echo search_url(); ?>" method="post">
						<input type="search" class="site-search__search-term" name="term" placeholder="Rechercher&hellip;" value="<?php echo search_term(); ?>">
					</form>
					...
					<nav role="navigation">
						<ul class="site-menu">
							...
							<li class="site-menu__list-item"><a class="site-menu__item-link" href="<?php echo base_url(); ?>" title="<?php echo site_name(); ?>">Acceuil</a></li>
	            ...
	            <?php endif; ?>
					...
					<?php endif; ?>
						<ul class="site-menu">
							<li class="site-menu__list-item--heading">Catégories <i class="fa fa-folder-open"></i></li>
